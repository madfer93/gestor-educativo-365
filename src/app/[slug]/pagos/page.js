        ...
        <div className="min-h-screen bg-slate-50 font-sans pb-24">
            ...
            <div className="text-white py-12 md:py-20 text-center relative overflow-hidden" style={{ backgroundColor: branding.primary }}>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <h1 className="text-3xl md:text-5xl font-black mb-4 uppercase tracking-tighter">Pagos en Línea</h1>
                    <p className="text-white/70 font-medium max-w-lg mx-auto italic">
                        Realiza tus pagos de forma segura y rápida a través de nuestra pasarela institucional.
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-6 -mt-10 relative z-20">
                <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
                    ...
                    {/* Payment Form */}
                    <div className="md:col-span-3 bg-white rounded-[40px] shadow-2xl border border-slate-100 p-8 md:p-12">
                        {status === "success" ? (
                            ...
                            <>
                                <div className="flex items-center gap-4 mb-10 border-b border-slate-100 pb-6">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-black text-slate-800">Detalles de la Transacción</h3>
                                ...
                                <form onSubmit={handlePay} className="space-y-8">
                                    ...
                                    <div className="bg-blue-50/50 p-6 rounded-3xl border border-blue-100/50 flex gap-4">
                                        ...
                                        <p className="text-xs text-blue-800 font-medium leading-relaxed">
                                            Recuerda verificar bien el monto y el concepto antes de proceder. Los pagos por PSE y Tarjeta de Crédito se reflejan de inmediato en nuestro sistema.
                                        </p>
                                    </div>
                                    ...
                                    >
                                        {status === "loading" ? (
                                            ...
                                            <>
                                                {school.wompi_url ? 'Abrir Pasarela Wompi' : 'Proceder al Pago'} <ArrowRight className="group-hover:translate-x-1 transition-transform" />
                                            </>
                                        )}
                                    </button>
                                </form>
                    ...
                    <div className="md:col-span-2 space-y-8">
                        {/* Cuentas Bancarias */}
                        {(school.bank_info?.bank1?.numero || school.bank_info?.bank2?.numero) && (
