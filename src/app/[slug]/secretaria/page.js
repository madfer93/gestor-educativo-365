                ...
                {activeTab === "perfil" && (
                    <div className="space-y-10">
                        <div>
                            ...
                            <p className="text-gray-500 font-medium">Actualiza tu biografía profesional y redes sociales.</p>
                        </div>
                            ...
                            <form onSubmit={handleSaveProfile} className="space-y-10">
                                <div className="flex items-center gap-8 border-b border-gray-50 pb-8">
                                    ...
                                    <div>
                                        ...
                                        <span className="px-3 py-1 bg-gray-100 text-gray-500 font-black text-[10px] uppercase tracking-widest rounded-full">{userProfile?.specialty || userProfile?.rol || 'Secretaría'}</span>
                                    </div>
                                </div>
