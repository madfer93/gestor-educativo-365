    ...
    return (
        <>
            ...
            <a
                ...
                className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[99] bg-gradient-to-r from-green-500 to-emerald-600 text-white px-8 py-4 rounded-full font-black text-sm uppercase tracking-widest shadow-2xl shadow-green-500/30 hover:scale-105 transition-all flex items-center gap-3 animate-bounce hover:animate-none"
