...
export default function ChatIA() {
    ...
    return (
        <>
            {/* Floating Center Button — Atención IA 24/7 */}
            <a
                href="https://wa.me/573229191905?text=Hola, necesito información sobre el Colegio Latinoamericano"
                target="_blank"
                rel="noopener noreferrer"
                className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[99] bg-gradient-to-r from-green-500 to-emerald-600 text-white px-8 py-4 rounded-full font-black text-sm uppercase tracking-widest shadow-2xl shadow-green-500/30 hover:brightness-110 transition-all flex items-center gap-3 animate-bounce hover:animate-none"
            ...
            <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end gap-3 font-sans">
                ...
                {showOptions && !isOpen && (
                    <div className="flex flex-col gap-3 mb-4 animate-in slide-in-from-bottom-5">
                        ...
                        {/* WhatsApp IA Botpress (24/7) */}
                        <a
                            href="https://wa.me/573229191905?text=Hola, necesito asesoría sobre el Colegio Latinoamericano"
                            target="_blank"
                            className="flex items-center gap-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 py-3 rounded-2xl font-black text-sm shadow-xl hover:scale-105 transition-transform"
                        >
                            <div className="flex-1">
                                <span className="block">WhatsApp IA 24/7</span>
                                <span className="text-[10px] font-bold opacity-80">🤖 Respuesta inmediata</span>
                            </div>
                            <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                                <Bot size={18} />
                            </div>
